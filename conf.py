...
BLOG_AUTHOR = "Ajith Kanumuri"  # (translatable)
BLOG_TITLE = "Ajith Kanumuri"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ajithkanumuri.me/"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/blog/', 'Blog', 'fa fa-pencil'),
        ('/categories/', 'Tags', 'fa fa-tags'),
        ('https://github.com/ajith05', 'GitHub', 'fab fa-github'),
    )
}
...
# Config for bootblog4 (not used by zen theme):
# THEME_CONFIG = {
#     DEFAULT_LANG: {
...
LUXON_DATE_FORMAT = {
    DEFAULT_LANG: {'preset': True, 'format': 'DATETIME_MED'},
}
...
# (translatable)
LICENSE = "Unless otherwise noted, all content on this website, including text, images, and code samples, is protected by copyright."
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; 2025-{date}         <a href="{github}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         <br>{license}'
...
RSS_COPYRIGHT = 'Copyright © {date} <a href="{github}">{author}</a> {license}'
RSS_COPYRIGHT_PLAIN = 'Copyright © {date} {author} {license}'
