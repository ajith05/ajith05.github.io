...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; 2025-<span id="footer-year"></span>         <a href="{github}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         <br>{license}<script>document.getElementById("footer-year").textContent=new Date().getFullYear();</script>'
